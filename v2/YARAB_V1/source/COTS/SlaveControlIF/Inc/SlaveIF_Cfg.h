...
// Configure as output, initial state low (EN)
gpio_pin_config_t enPinConfig = {
		.pinDirection = kGPIO_DigitalOutput,
		.outputLogic = 0U // Default to low
};

// Configure as Input (INT-B)
gpio_pin_config_t intbPinConfig = {
		.pinDirection = kGPIO_DigitalInput,
		.outputLogic = 0U // Not applicable for input
};


#define enTransceiverPin 0U
#define enTransceiverGPIO GPIOE
#define intbTransceiverPin 12U
#define intbTransceiverGPIO GPIOA
